...
- (void)viewDidLoad
{
    ...
    fullPathOfDoc=[NSString stringWithFormat:@"https://www.contractorsischool.com/staff/review_document/%@",self.doc_name];
...
{
    NSString *url=[NSString stringWithFormat:@"https://www.contractorsischool.com/mobile-services/documentreview.php?id=%@",self.idDocomentCorrection];
