...
{
//   NSString *requestURL=[NSString stringWithFormat:@"https://www.contractorsischool.com/mobile-services/get_level0_testdetail.php"];
    NSString *requestURL=[NSString stringWithFormat:@"https://www.contractorsischool.com/mobile-services/get_demo_testdetail.php"];
...
-(void)TestExam2 {
    ...
    NSString *requestURL=[NSString stringWithFormat:@"https://www.contractorsischool.com/mobile-services/get_test_subtests_details_updated.php"];
    
   //NSString *requestURL=[NSString stringWithFormat:@"http://192.168.1.5/mobile-services/get_test_subtests_details_updated.php"];
    
   // NSString *requestURL=[NSString stringWithFormat:@"http://192.168.0.12/ExamPrep/Services/get_test_subtests_details_updated.php"];
    
   // NSString *requestURL=[NSString stringWithFormat:@"http://192.168.0.12/ExamPrep/Services/get_test_subtests_details.php"];
