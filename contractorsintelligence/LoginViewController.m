    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if([[dict objectForKey:@"Result"] isEqualToString:@"True"] )
            {
                ...
                [[NSUserDefaults standardUserDefaults] setObject:[userinfoS objectForKey:@"firsttime"] forKey:@"firsttime"];
                ...
                else
                {
                    ...
                    /*
                    if([[userDict objectForKey:@"firsttime"] isEqualToString:@"1"]){
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if([[dict objectForKey:@"Result"] isEqualToString:@"True"])
            {
                ...
                else
                {
                    ...
                    AgreementViewController *dashOneView=[[AgreementViewController alloc] initWithNibName:@"AgreementViewController" bundle:nil];
                    [self.navigationController pushViewController:dashOneView animated:YES];
