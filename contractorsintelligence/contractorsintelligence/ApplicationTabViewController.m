...
- (void)viewDidLoad
{
    ...
    if([notifiacation isEqualToString:@"1"])
    {
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
        {
        [self.btn_tab_viewForApp setImage:[UIImage imageNamed:@"btn_videos_for_application1@2x.png"] forState:UIControlStateNormal];
        ...
        {
            [self.btn_tab_viewForApp setImage:[UIImage imageNamed:@"btn_videos_for_application_iPad@2x.png"] forState:UIControlStateNormal];
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        btn_video_Image=@"btn_videos_for_application1@2x.png";
        ...
        btn_video_Image_hover=@"btn_videos_for_application_hover1@2x.png";
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
        {
            ...
            {
                [uploadAppCell.lblReviewStatus setText:@"Not Review"];
            }
            else
            {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *urlImage=[NSString stringWithFormat:@"http://www.contractorsintelligence.com/staff/review_document/%@",[dicimageUpload objectForKey:@"doc_name"]];
...
-(void) loadViewCorrections
{
    ...
    NSString *requestURL=[NSString stringWithFormat:@"http://www.contractorsintelligence.com/Services/dispalyapplicationreview.php?email=%@",strUserEmail];
...
-(void) loadUploadedApplication
{
    ...
    NSString *strUserEmail=[[[NSUserDefaults standardUserDefaults] objectForKey:@"userData"] objectForKey:@"email"];
    NSString *requestURL=[NSString stringWithFormat:@"http://www.contractorsintelligence.com/Services/dispalyapplicationupload.php?email=%@",strUserEmail];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if([[dict objectForKey:@"Result"] isEqualToString:@"True"])
            {
                ...
                NSLog(@"%lu",(unsigned long)[self.arrUploadedApp count]);
...
- (IBAction)btnVideo1:(id)sender {
    ...
    OpenVideoViewController *openVideo=[[OpenVideoViewController alloc]initWithNibName:@"OpenVideoViewController" bundle:nil];
        openVideo.VideoURL=[NSString stringWithFormat:@"http://www.contractorsintelligence.com/videos/ipad/application-video-1iPad.mp4"];
...
- (IBAction)btnVideo2:(id)sender {
    OpenVideoViewController *openVideo=[[OpenVideoViewController alloc]initWithNibName:@"OpenVideoViewController" bundle:nil];
       openVideo.VideoURL=[NSString stringWithFormat:@"http://www.contractorsintelligence.com/videos/ipad/application-video-2iPad.mp4"];
    [self presentViewController:openVideo animated:YES completion:nil];
    //[self.navigationController pushViewController:openVideo animated:YES];
...
- (IBAction)btnVideo3:(id)sender {
    ...
    OpenVideoViewController *openVideo=[[OpenVideoViewController alloc]initWithNibName:@"OpenVideoViewController" bundle:nil];
    openVideo.VideoURL=[NSString stringWithFormat:@"http://www.contractorsintelligence.com/videos/ipad/application-video-3iPad.mp4"];
   [self presentViewController:openVideo animated:YES completion:nil];
    //[self.navigationController pushViewController:openVideo animated:YES];
