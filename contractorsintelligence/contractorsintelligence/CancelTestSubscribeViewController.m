...
-(void)jsonCallforTestSubscibe
{
    ...
    NSString *url=[NSString stringWithFormat:@"http://www.contractorsintelligence.com/Services/displayexpireinfo.php?email=%@",email];
...
-(void)jsonCallforCancelTestSubsciber
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://www.contractorsintelligence.com/Services/cancel_subsciption.php"]];
